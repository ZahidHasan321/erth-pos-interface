        ...
        <CardContent className="py-4">
          {isLoading ? (
            ...
            <div className="py-10 text-center">
              <AlertCircle className="h-8 w-8 mx-auto mb-3 text-[var(--status-bad)] opacity-70" />
                    ...
                    <TableRow key={s.id} className={cn(s.is_archived && "opacity-60")}>
                      <TableCell className="font-medium">
                        <div className="flex items-center gap-2">
                          {s.name}
                          {s.is_archived && (
                            <span className="inline-flex items-center rounded-md border border-border bg-muted px-1.5 py-0.5 text-xs font-medium text-muted-foreground">Archived</span>
                          )}
                        </div>
                      </TableCell>
                      <TableCell>
                  ...
                  {filtered.length === 0 && (
                    <TableRow>
                      <TableCell colSpan={5} className="py-2">
                        <EmptyState
                          icon={Users}
                          message={suppliers.length === 0 ? "No suppliers yet — add one to start tracking restocks." : "No suppliers match the search."}
                        />
                      </TableCell>
                    </TableRow>
                  )}

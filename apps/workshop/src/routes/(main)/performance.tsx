...
function WorkerTable({
  ...
  return (
    <div className="border rounded-xl overflow-hidden bg-card shadow-sm">
      ...
      {filtered.length === 0 ? (
        <div className="px-5 py-12 text-center text-muted-foreground/40 text-sm">
        ...
        filtered.map((w, i) => {
          ...
          return (
            <div key={`${w.name}-${w.stage}-${i}`} className="border-b last:border-b-0 hover:bg-muted/5 transition-colors">
              {/* Desktop */}
              <div className="hidden md:grid grid-cols-[1fr_90px_90px_70px_120px_70px_70px_60px] gap-2 px-5 py-3 items-center">
                ...
                <div className="flex flex-col gap-1.5">
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-muted-foreground/50 tabular-nums">{w.dailyTarget || "\u2014"}</span>
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="bg-card border rounded-xl p-4 shadow-sm">
            <p className="text-[10px] font-black uppercase tracking-[0.15em] text-muted-foreground/50 mb-3">Filter by Stage</p>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            ...
            <div className="bg-card border rounded-xl p-5 shadow-sm">
              <div className="flex items-center justify-between mb-4">
                <p className="text-[10px] font-black uppercase tracking-[0.15em] text-muted-foreground/50">Daily Output</p>
            ...
            {/* Stage Breakdown */}
            <div className="bg-card border rounded-xl p-5 shadow-sm">
              <p className="text-[10px] font-black uppercase tracking-[0.15em] text-muted-foreground/50 mb-4">Stage Throughput</p>
              {stageChartData.length > 0 ? (
                <ResponsiveContainer width="100%" height={220}>
                  <BarChart data={stageChartData} layout="vertical" barCategoryGap={8} margin={{ right: 50 }}>
                    ...
                    />
                    <Bar dataKey="target" fill="var(--muted)" radius={[0, 4, 4, 0]} barSize={14} opacity={0.3} />
                    <Bar
                      dataKey="actual"
                      radius={[0, 4, 4, 0]}
                      barSize={14}

...
const measurementOverlayBoxes = {
  ...
  backChest: { left: 3.2, top: 67.171, width: 12.682, height: 5.903 },
...
const buildMeasurementOverlayValues = (
  ...
  return {
    collarLength: formatMeasurement(onGarment?.collar?.length),
    collarWidth: formatMeasurement(onGarment?.collar?.width),
    ...
    backChest: formatMeasurement(onGarment?.backChest),

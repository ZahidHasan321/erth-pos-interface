...
export function SimplifiedCustomerForm({
    ...
    const inputClasses = cn(
        "h-12 font-bold transition-all text-base",
        hasCustomer ? "bg-muted/50 border-transparent shadow-none" : "bg-background border-border"
    );
    ...
    return (
        <div className="w-full" ref={containerRef}>
            <Card className={cn(
                ...
                hasCustomer ? "border-primary/30 bg-primary/[0.02] shadow-sm" : "border-border bg-card shadow-sm"
            )}>
                <CardHeader className="pb-5 flex flex-row items-center justify-between border-b bg-muted/20">
                    <div className="space-y-1">
                        <CardTitle className="text-xl font-black uppercase tracking-tight flex items-center gap-2.5">
                            <div className={cn(
                                "p-1.5 rounded-lg",
                                hasCustomer ? "bg-primary text-primary-foreground" : "bg-muted text-muted-foreground"
                            )}>
                                <User className="size-4" />
                            </div>
                            Customer <span className="text-primary">Identity</span>
                        </CardTitle>
                    </div>
                    {hasCustomer && (
                        <Button 
                            ...
                            className="h-8 text-[10px] font-black uppercase tracking-widest border-destructive/20 text-destructive hover:bg-destructive hover:text-white transition-all"
                        >
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-12 gap-6 items-end">
                                            ...
                                            >
                                                {customers.length > 0 ? (
                                                    ...
                                                    <div className="p-8 text-center bg-muted/5">
                                                        ...
                                                        <p className="text-[10px] font-bold text-muted-foreground/40 uppercase mt-1">Continue to create new profile</p>
                                                    </div>
                                                )}
                                            </motion.div>
                                        )}
                        ...
                        <div className="md:col-span-1 flex justify-end">
                            {!hasCustomer && !isOrderClosed && (
                                <Button 
                                    className="h-12 w-full font-black uppercase tracking-widest text-[10px] gap-2 shadow-lg shadow-primary/20"
                            ...
                            {hasCustomer && (
                                <div className="h-12 flex items-center justify-center w-full">
                                    <div className="size-10 bg-emerald-500 rounded-xl flex items-center justify-center text-white shadow-lg shadow-emerald-500/20 border-2 border-white/20">

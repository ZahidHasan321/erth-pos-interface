...
// Plain-language value for a changed style field. Returns null only for blank
// values so they never surface as a chip; an explicit boolean false is a real
// "No / remove" change and shows as such.

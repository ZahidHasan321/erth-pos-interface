  ...
  const CompactStat = ({ 
    ...
    <div className={cn(
      ...
      className
       ...
       <div>
          <p className="text-[8px] font-black uppercase tracking-wider text-muted-foreground leading-none mb-1">{label}</p>
  ...
  return (
    <div className="space-y-6 mx-4 lg:mx-8 my-8 max-w-[1600px] 2xl:mx-auto">
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 border-b border-border pb-6">
        ...
        <div className="flex items-center gap-2.5 bg-primary/5 px-3 py-1.5 rounded-xl border border-primary/10">
          <TrendingUp className="w-3.5 h-3.5 text-primary" />
          <span className="text-[10px] font-black uppercase tracking-widest text-primary">{filteredOrders.length} ACTIVE ORDERS</span>
        </div>
      </div>

      <div className="flex flex-col xl:flex-row gap-4 items-start">
        {/* Filters Section - More constrained width */}
